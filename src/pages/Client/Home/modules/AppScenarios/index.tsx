          ...
          {list.map((item, index) => {
            return (
              ...
              >
                <div
                  style={{
                    backgroundImage: `url(${require(`@/assets/images/client/gansu/${item.icon}`)})`,
                    width: 48,
                    height: 48,
                    marginRight: 25,
